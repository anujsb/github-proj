          ...
          <div className="w-full max-w-lg">
            <div className="p-4 bg-white shadow-lg rounded-xl flex flex-col md:flex-row items-center">
              <div className="flex-1 p-2">
                <h1 className="text-lg md:text-xl font-semibold">Third party logging</h1>
                <p className="text-sm md:text-base text-gray-600 dark:text-gray-300 mt-2">
                  Can we store the prompts we send to Azure&apos;s OpenAI service? Disabling this will mean the team is unable to provide support.
                </p>
              </div>
